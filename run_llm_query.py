...
from query_memory import log_success, log_failure
import json
import os
import decimal
import datetime
...
try:
    ...
    schema_path = os.path.abspath(os.path.join(base_dir, "output/wincasa_schema_summary.yaml"))
...
try:
    ...
    print("\n❌ Fehler:", str(e))
    log_query_result(prompt, sql if 'sql' in locals() else None, None, success=False, error=str(e))
