    ...
    try:
        ...
        if table_names:
            ...
            try:
                ...
                print(
                    f"✓ SQL-Abfrage erfolgreich ausgeführt. {len(results)} Zeilen zurückgegeben:"
                )
        ...
        if "BEWOHNER" in table_names:
            ...
            try:
                ...
                print(
                    f"✓ BEWOHNER-Abfrage erfolgreich. {len(bewohner_results)} Zeilen:"
                )
...
def test_complex_queries():
    ...
    try:
        ...
        print(
            f"✓ JOIN-Abfrage für BEWADR erfolgreich. {len(join_results)} Zeilen zurückgegeben"
        )
        ...
        print(
            f"✓ Aggregationsabfrage erfolgreich. {len(aggregation_results)} Zeilen zurückgegeben"
        )
