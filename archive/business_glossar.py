...
# Import FK Graph Analyzer for JOIN reasoning
try:
    from fk_graph_analyzer import JoinPath, fk_graph_analyzer
except ImportError:
    print("⚠️ FK Graph Analyzer not available. JOIN reasoning will be limited.")
    fk_graph_analyzer = None
    JoinPath = None
...
class BusinessTerm:
    ...
    join_complexity: int = 1  # Number of tables involved in JOINs
    requires_subquery: bool = False  # Whether term needs subquery
    ...
    def __post_init__(self):
        ...
        if self.examples is None:
            self.examples = []
        # Auto-calculate join complexity based on tables involved
        if self.join_complexity == 1:
            self.join_complexity = max(1, len(self.tables_involved))
...
class BusinessGlossar:
    ...
    def _initialize_wincasa_terms(self):
        ...
        financial_terms = [
            ...
            BusinessTerm(
                ...
                examples=[
                    "Welche Kautionen wurden hinterlegt?",
                    "Zeige Sicherheitsleistungen",
                ],
            ),
            BusinessTerm(
                term="Nebenkosten",
        ...
        status_terms = [
            ...
            BusinessTerm(
                ...
                examples=[
                    ...
                    "Zeige beendete Mietverhältnisse",
                ],
            ),
        ]
    ...
    ) -> List[Tuple[str, BusinessTerm, float]]:
        """
    ...
    def resolve_terms_to_sql(
        self, terms: List[BusinessTerm], query_context: str = ""
    ) -> Dict[str, any]:
        """
    ...
    def _generate_join_hints(self, tables: Set[str]) -> List[str]:
        ...
        join_patterns = {
            ...
            (
                "BEWOHNER",
                "KONTEN",
            ): "BEWOHNER.ONR = KONTEN.ONR AND BEWOHNER.KNR = KONTEN.KNR",
    ...
    def get_enhanced_context_for_terms(
        self, terms: List[BusinessTerm]
    ) -> List[Document]:
        """
