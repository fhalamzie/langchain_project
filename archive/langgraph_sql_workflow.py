...
class LangGraphSQLWorkflow:
    ...
    def __init__(
        self, db_interface, llm, enable_monitoring: bool = True, max_iterations: int = 3
    ):
        """
    ...
    def _build_workflow(self):
        ...
        workflow.add_conditional_edges(
            ...
            {"validate": "validate_sql", "skip_validation": "execute_sql"},
        )
        ...
        workflow.add_conditional_edges(
            ...
            {"valid": "execute_sql", "invalid": "handle_error", "max_retries": END},
        )
        ...
        workflow.add_conditional_edges(
            ...
            {"success": "format_answer", "error": "handle_error", "max_retries": END},
        )
    ...
    def _extract_business_entities(self, state: QueryState) -> Dict[str, Any]:
        ...
        return {"business_entities": entities, "business_mappings": mappings}
    ...
    def _find_required_tables(self, state: QueryState) -> Dict[str, Any]:
        ...
        return {"required_tables": tables, "join_paths": join_paths}
    ...
    def _retrieve_enhanced_context(self, state: QueryState) -> Dict[str, Any]:
        ...
        return {"retrieved_context": context, "context_quality": quality}
    ...
    def _generate_sql_query(self, state: QueryState) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"generated_sql": sql, "iterations": state.get("iterations", 0) + 1}
        except Exception as e:
            return {
                "generated_sql": "",
                "error_message": str(e),
    ...
    def _validate_sql_query(self, state: QueryState) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "generated_sql": (
                    result.fixed_sql
                    if hasattr(result, "fixed_sql")
                    else state["generated_sql"]
                ),
            }
        except Exception as e:
            return {"sql_valid": False, "sql_errors": [str(e)]}
    ...
    def _execute_sql_query(self, state: QueryState) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"sql_results": results, "success": True}
        except Exception as e:
            return {"sql_results": None, "success": False, "error_message": str(e)}
    ...
    def _handle_error_recovery(self, state: QueryState) -> Dict[str, Any]:
        ...
        if iterations >= self.max_iterations:
            return {
                "success": False,
                "final_answer": (
                    f"Max retries ({self.max_iterations}) exceeded. Last error: {state.get('error_message', 'Unknown')}"
                ),
            }
...
SQL Query:"""
    ...
    def process_query(
        self, user_query: str, config: Optional[Dict] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {
                ...
                "documents_retrieved": len(
                    final_state.get("retrieved_context", "").split("\n\n")
                ),
...
def test_langgraph_workflow():
    ...
    try:
        ...
        workflow = LangGraphSQLWorkflow(
            db_interface=MockDBInterface(), llm=MockLLM(), enable_monitoring=False
        )
