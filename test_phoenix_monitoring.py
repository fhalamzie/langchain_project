...
class TestPhoenixMonitor(unittest.TestCase):
    ...
    def test_multiple_retrieval_averaging(self):
        ...
        self.assertAlmostEqual(enhanced_metrics['avg_documents'], 4.0, places=1)  # (3+4+5)/3
        self.assertAlmostEqual(enhanced_metrics['avg_relevance'], 0.85, places=2)  # (0.8+0.85+0.9)/3
        self.assertAlmostEqual(enhanced_metrics['avg_duration'], 1.5, places=1)  # (1.0+1.5+2.0)/3
