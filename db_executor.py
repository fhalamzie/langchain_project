...
SAFE_TABLES = set()  # Tabellen, die als sicher für Abfragen eingestuft sind (wird später gefüllt)
...
def validate_sql(sql: str) -> Tuple[bool, str]:
    ...
    dangerous_operations = [
        ...
        r'\bDELETE\b', r'\bINSERT\b', r'\bUPDATE\b', r'\bGRANT\b', 
...
def get_from_cache(query_hash: str, max_age_seconds: int = 3600) -> Optional[List[Dict[str, Any]]]:
    """
...
def execute_sql(sql: str, params: Optional[Dict[str, Any]] = None, use_cache: bool = True, 
                max_cache_age: int = 3600) -> Tuple[bool, Union[List[Dict[str, Any]], str]]:
    """
