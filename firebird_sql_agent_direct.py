...
class FirebirdDirectSQLAgent:
    ...
    def __init__(self, db_connection_string: str, llm: Any, retrieval_mode: str = 'faiss', neo4j_config: Dict = None):
        ...
        Args:
            ...
            retrieval_mode: 'faiss' oder 'neo4j'
    ...
    def _setup_direct_sql_agent(self):
        ...
        try:
            ...
            # System-Nachricht für den Agent
            system_message = """
...
Thought:{agent_scratchpad}"""
    ...
    def query(self, natural_language_query: str, retrieval_mode_override: Optional[str] = None) -> Dict[str, Any]:
        ...
        if current_retrieval_mode == 'faiss' and self.faiss_retriever:
            ...
            print("Neo4j retriever selected but not fully implemented yet.")
        ...
        # Erweiterte Abfrage für den Agent
        ...
        Bitte beantworte die folgende Frage: {natural_language_query}
        """
